...
public interface IObsClient {
	 ...
	 * @param bucketName 桶名
	 * @param objectKey 文件名或目录名
	 * @param newObjectKey 重命名后的文件名或目录名
	 * @return 重命名响应结果
