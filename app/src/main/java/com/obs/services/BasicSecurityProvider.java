...
public class BasicSecurityProvider implements ISecurityProvider {
    ...
    public BasicSecurityProvider(ISecurityKey securityKey) {
        setSecurityKey(securityKey);
    }

    public BasicSecurityProvider(String accessKey, String secretKey) {
        this(accessKey, secretKey, null);
    }

    public BasicSecurityProvider(String accessKey, String secretKey, String securityToken) {
