...
public abstract class SecretFlexibleBucketObsClient extends ObsClient {
    ...
    protected void setContextProviderCredentials(String accessKey, String secretKey, String securityToken) {
    ...
    protected void setContextProviderCredentials(String accessKey, String secretKey) {
